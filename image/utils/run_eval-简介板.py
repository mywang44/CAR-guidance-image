...
CONFIG = {
    ...
    # 修改为你当前的生成结果路径
    "base_gen_dir": "/home/users/meiyi/Guided-Flow-Matching-with-Optimal-Control/image/examples/1gcar_gcovA_multiprompt_lr5.0-notdetach/res-result/SmileSad",     
    
    "prompts": [
        # "A photo of a angry face.",
        # "A photo of a curly hair face.",
...
def main():
    ...
    for img_id in id_list:
        ...
        gen_img_dir = os.path.join(CONFIG["base_gen_dir"], img_id) 
        ...
        img_files = [f for f in os.listdir(gen_img_dir) if f.lower().endswith(valid_extensions)]
